...
Structured reference for $architect. Load on first invocation per session. Use to identify quality attributes, frame trade-offs, and generate ADR documents.
