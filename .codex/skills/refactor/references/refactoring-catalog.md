...
Structured reference for $refactor. Load on first invocation per session. Use to identify code smells, name the corresponding refactoring, and guide the transformation.
