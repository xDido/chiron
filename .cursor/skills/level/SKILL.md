...
If the current project's `.cursorrules` says to ignore level settings or pin chiron to a specific level, follow those instructions. User config always overrides.
