...
If the current project's `.github/copilot-instructions.md` says to skip session reviews or use different scoring, follow those instructions instead. This command is opt-in.
