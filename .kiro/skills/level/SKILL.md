...
If the current project's `.kiro/settings.json` says to ignore level settings or pin chiron to a specific level, follow those instructions. User config always overrides.
