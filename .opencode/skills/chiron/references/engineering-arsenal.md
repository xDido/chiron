...
Named backend patterns organized by domain. Reference when presenting /tour preambles, when /chiron teaches architectural concepts, or when /challenge drills touch system-level patterns. Each entry: pattern name, one-sentence description, when to reach for it.
