...
Map to a named smell from `.opencode/skills/refactor/references/refactoring-catalog.md`. Read the catalog on first L1 encounter per session.
...
6. No AI code tells (check against `.opencode/skills/refactor/../chiron/references/ai-code-tells.md`)
