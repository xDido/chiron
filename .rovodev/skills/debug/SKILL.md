...
Map symptoms to a root cause category from `.rovodev/skills/debug/references/debugging-playbook.md`. Read the playbook on first L1 encounter per session. Name the category without naming the specific cause.
...
5. No AI code tells (check against `.rovodev/skills/debug/../chiron/references/ai-code-tells.md`)
