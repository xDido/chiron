...
Map to a named smell from `.rovodev/skills/refactor/references/refactoring-catalog.md`. Read the catalog on first L1 encounter per session.
...
6. No AI code tells (check against `.rovodev/skills/refactor/../chiron/references/ai-code-tells.md`)
