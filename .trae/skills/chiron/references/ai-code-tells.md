...
Patterns that reveal AI-generated code. Flag these during L3/L4 code review and /challenge grading. A "tell" is code that works but signals the author didn't think — a senior engineer would refactor before committing.
