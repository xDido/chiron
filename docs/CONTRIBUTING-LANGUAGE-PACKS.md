...
This guide explains how to add a new language pack to chiron. chiron v0.5.0 ships with nine bundled packs (Go, Rust, Python, JavaScript, TypeScript, Java, C#, Kotlin, Swift). Community contributions for additional languages — Ruby, Zig, Elixir, and anything else — are most welcome.
