...
# {{command_prefix}}teach — generate project context for chiron
...
Auto-generated by {{command_prefix}}teach — re-run to refresh. Delete to force a full rescan.
...
4. Remind them: *"All chiron skills will now use `.chiron-context.md` instead of re-scanning. Run `{{command_prefix}}teach` again anytime to refresh."*
